...
public class FirstLay extends MainActivity {
    ...
    public void next_1(View view) {
        ...
        if (check4) {
            score = ++score;
            Toast.makeText(this, getString(R.string.greatJ)+".", Toast.LENGTH_LONG).show();
        } else if (check1) {
    ...
    private void nextToThirdPage(View view) {
        ...
        Intent intent = new Intent(this, SecondLay.class);
