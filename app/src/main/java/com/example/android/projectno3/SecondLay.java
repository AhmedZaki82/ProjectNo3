...
public class SecondLay extends FirstLay {
    static int score;
    ...
    public void next_2(View view) {
        ...
        if (check4) {
            ...
            Toast.makeText(this, getString(R.string.excellentJ)+".", Toast.LENGTH_LONG).show();
        } else if (check1) {
    ...
    private void nextToFourthPage(View view) {
        ...
        Intent intent = new Intent(this, ThirdLay.class);
